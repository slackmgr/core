...
func WebhookInputView(webhook *client.Webhook) []slack.Block {
	blocks := []slack.Block{}
...
func createStringInputBlock(input *client.WebhookPlainTextInput) slack.Block {
...
func createCheckboxInputBlock(input *client.WebhookCheckboxInput) slack.Block {
