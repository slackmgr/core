...
type APIConfig struct {
	...
	LogJSON bool `json:"logJson" mapstructure:"logJson" yaml:"logJson"`
	...
	RestPort string `json:"restPort" mapstructure:"restPort" yaml:"restPort"`
	...
	ErrorReportChannelID string `json:"errorReportChannelId" mapstructure:"errorReportChannelId" yaml:"errorReportChannelId"`
	...
	MaxUsersInAlertChannel int `json:"maxUsersInAlertChannel" mapstructure:"maxUsersInAlertChannel" yaml:"maxUsersInAlertChannel"`
...
type RateLimitConfig struct {
	...
	AlertsPerSecond float64 `json:"alertsPerSecond" mapstructure:"alertsPerSecond" yaml:"alertsPerSecond"`
	...
	AllowedBurst int `json:"allowedBurst" mapstructure:"allowedBurst" yaml:"allowedBurst"`
}
