...
type SlackClientConfig struct {
	...
	// App-Level Tokens.
	AppToken string `json:"appToken" mapstructure:"appToken" yaml:"appToken"`
	...
	BotToken string `json:"botToken" mapstructure:"botToken" yaml:"botToken"`
	...
	DebugLogging bool `json:"debugLogging" mapstructure:"debugLogging" yaml:"debugLogging"`
	...
	DryRun bool `json:"dryRun" mapstructure:"dryRun" yaml:"dryRun"`
	...
	MaxAttemptsForRateLimitError int `json:"maxAttemptsForRateLimitError" mapstructure:"maxAttemptsForRateLimitError" yaml:"maxAttemptsForRateLimitError"`
	...
	// between 1 and 100.
	MaxAttemptsForTransientError int `json:"maxAttemptsForTransientError" mapstructure:"maxAttemptsForTransientError" yaml:"maxAttemptsForTransientError"`
