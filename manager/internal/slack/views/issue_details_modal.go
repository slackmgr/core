...
func IssueDetailsAssets(issue *models.Issue, conf *config.ManagerConfig) (slack.Blocks, error) {
...
func formatTimestamp(t time.Time, conf *config.ManagerConfig) string {
