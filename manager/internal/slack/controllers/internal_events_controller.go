...
func (c *internalEventsController) handleEventTypeHello(_ context.Context, evt *socketmode.Event) {
	c.logger.WithField("operation", "slack").WithField("event_type", evt.Type).Info("Slack socket mode connected")
}

func (c *internalEventsController) handleEventTypeDisconnect(_ context.Context, evt *socketmode.Event) {
